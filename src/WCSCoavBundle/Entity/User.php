 ...
 *
 * @ORM\Table(name="user")
 * @ORM\Entity(repositoryClass="WCSCoavBundle\Repository\UserRepository")
 */
class User
{
    /**
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Reservation", inversedBy="passengers")
     ...
     * Add reservation
     *
     * @param \WCSCoavBundle\Entity\Reservation $reservation
     *
     * @return User
     */
    public function addReservation(\WCSCoavBundle\Entity\Reservation $reservation)
    {
     ...
     * @param \WCSCoavBundle\Entity\Reservation $reservation
     */
    public function removeReservation(\WCSCoavBundle\Entity\Reservation $reservation)
    {
     ...
     * Add review
     *
     * @param \WCSCoavBundle\Entity\Review $review
     *
     * @return User
     */
    public function addReview(\WCSCoavBundle\Entity\Review $review)
    {
        $this->reviews[] = $review;
     ...
     * @param \WCSCoavBundle\Entity\Review $review
     */
    public function removeReview(\WCSCoavBundle\Entity\Review $review)
    {
